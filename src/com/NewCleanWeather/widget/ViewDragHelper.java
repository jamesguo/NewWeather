...
public class ViewDragHelper {
     ...
     * The callback's {@link com.NewCleanWeather.widget.ViewDragHelper.Callback#onEdgeTouched(int, int)} and
     * {@link com.NewCleanWeather.widget.ViewDragHelper.Callback#onEdgeDragStarted(int, int)} methods will only be invoked
     ...
     * but {@link com.NewCleanWeather.widget.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)} will not be asked permission to
     * capture this view.
     *
...
//        if(finalTop<=getActionBarHeight()){
//            finalTop = getActionBarHeight();
//        }
    ...
    private int getActionBarHeight(){
        ...
        if (mCapturedView.getContext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            actionBarHeight = TypedValue.complexToDimensionPixelSize(tv.data,mCapturedView.getContext().getResources().getDisplayMetrics());
        }
...
//            Log.e(TAG,"mCapturedView.getTop() = "+mCapturedView.getTop()+" mScroller.getCurrY() = "+mScroller.getCurrY());
            if (dx != 0) {
     ...
     * The child order is determined using {@link com.NewCleanWeather.widget.ViewDragHelper.Callback#getOrderedChildIndex(int)}.
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
