...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * No-op stubs for {@link com.NewCleanWeather.widget.SlidingUpPanelLayout.PanelSlideListener}. If you only want to implement a subset
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child == mMainView && !mOverlayContent && mSlideState != SlideState.HIDDEN) {
                height -= mPanelHeight;
//                Log.e(TAG,"mMainView hight = "+height);
            }
    ...
    private boolean collapsePanel(View pane, int initialVelocity) {
        ...
        collapse =  smoothSlideTo(0.0f, initialVelocity);
        return mFirstLayout||collapse;
    }
...
//        Log.e(TAG,"mIsSlidingUp "+mIsSlidingUp+" slideOffset = "+slideOffset+" mSlideRange = "+mSlideRange);
...
//        final int topBoundCollapsed = computePanelTopPosition(getActionBarHeight());
    ...
    public boolean isPanelDragging() {
        return mSlideState == SlideState.DRAGGING;
    }
    /**
    ...
    private void onPanelDragged(int newTop) {
        ...
        mSlideOffset = computeSlideOffset(newTop);
//        Log.e(TAG,"onPanelDragged "+newTop);
...
//        if (child == mMainView) {
//             Log.e(TAG,"mMainView getTranslationY = "+mMainView.getTranslationY()+" childTop = "+mMainView.getTop());
//            Log.e(TAG,"mMainView child = "+child.findViewById(R.id.main).getBottom());
//        }
