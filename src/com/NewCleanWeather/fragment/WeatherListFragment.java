 ...
 */
public class WeatherListFragment extends HeaderFragment {
...
//        }
    ...
    private static class AsyncLoadSomething extends AsyncTask<Void, Void, String[]> {
        ...
        final WeakReference<WeatherListFragment> weakFragment;

        public AsyncLoadSomething(WeatherListFragment fragment) {
            this.weakFragment = new WeakReference<WeatherListFragment>(fragment);
        }
        ...
        protected void onPreExecute() {
            ...
            final WeatherListFragment audioFragment = weakFragment.get();
