...
//        Log.e("mDetailsViewPosition", mDetailsViewPosition.toString());
...
//        Rect out = new Rect();
//        out.set(mDetailsPlaceHolderView.getLeft(), mDetailsPlaceHolderView.getTop(),
//                mDetailsPlaceHolderView.getLeft() + mDetailsPlaceHolderView.getWidth(), mDetailsPlaceHolderView.getTop() + mDetailsPlaceHolderView.getHeight());
//        Log.e("mDetailsPlaceHolderView", out.toString());
    }
...
//        Log.e("mCoverViewPosition", mCoverViewPosition.toString());
...
//        Rect out = new Rect();
//        out.set(mCoverPlaceHolderView.getLeft(), mCoverPlaceHolderView.getTop(),
//                mCoverPlaceHolderView.getLeft() + mCoverPlaceHolderView.getWidth(), mCoverPlaceHolderView.getTop() + mCoverPlaceHolderView.getHeight());
//        Log.e("mCoverPlaceHolderView", out.toString());
    }
...
//        Log.e("setTranslationY","setTranslationY = "+(fromY - toY) * (1 - stage));
        // tracking states
...
//            Log.e("onFoldRotationChanged","coverScale = "+coverScale);
...
//            Log.e("onFoldRotationChanged","detailsScale = "+detailsScale);
...
//            Log.e("onFoldRotationChanged","dH = "+dH+" translationY = "+translationY);
...
//                Log.e("onLayout", mVisibleBounds.toString());
//                Rect out = new Rect();
//                out.set(this.getLeft(), this.getTop(),
//                        this.getLeft() + this.getWidth(), this.getTop() + this.getHeight());
//                Log.e("CoverHolderLayout", out.toString());
